...
def main():
    ...
    for i in range(4609000, total_count, 1000):
        ...
        if len(items):
            engine.execute(text("INSERT INTO jobs_keys (tid, title_key, info_key) VALUES (:tid, :title_key, :info_key)").execution_options(autocommit=True), items )
